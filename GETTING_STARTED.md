...
- Database: The database is a MySQL server that is hosted remotely. The backend will access it to get data. To set up your own databse to match the one used in produciton, execute the database creation script `init_databse.sql` (intended for MySQL) `
